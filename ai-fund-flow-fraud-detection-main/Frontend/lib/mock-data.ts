...
export const graphEdges = [
  { id: 'e1', source: 'ACC001', target: 'ACC002', animated: true, style: { stroke: 'var(--chart-3)' }, data: { amount: 15000, suspicious: true } },
  { id: 'e2', source: 'ACC002', target: 'ACC003', animated: true, style: { stroke: 'var(--chart-3)' }, data: { amount: 14999, suspicious: true } },
  { id: 'e3', source: 'ACC003', target: 'ACC004', animated: true, style: { stroke: 'var(--chart-3)' }, data: { amount: 14998, suspicious: true } },
  { id: 'e4', source: 'ACC004', target: 'ACC001', animated: true, style: { stroke: 'var(--chart-3)' }, data: { amount: 44000, suspicious: true } },
  { id: 'e5', source: 'ACC005', target: 'ACC006', style: { stroke: 'var(--chart-2)' }, data: { amount: 5000, suspicious: false } },
  { id: 'e6', source: 'ACC006', target: 'ACC007', style: { stroke: 'var(--chart-2)' }, data: { amount: 8500, suspicious: false } },
  { id: 'e7', source: 'ACC007', target: 'ACC008', animated: true, style: { stroke: 'var(--chart-4)' }, data: { amount: 25000, suspicious: true } },
  { id: 'e8', source: 'ACC008', target: 'ACC009', animated: true, style: { stroke: 'var(--chart-3)' }, data: { amount: 24999, suspicious: true } },
  { id: 'e9', source: 'ACC001', target: 'ACC005', style: { stroke: 'var(--chart-2)' }, data: { amount: 3500, suspicious: false } },
